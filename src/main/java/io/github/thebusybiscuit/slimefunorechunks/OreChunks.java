...
public class OreChunks extends JavaPlugin implements SlimefunAddon {
	...
	public void onEnable() {
		...
		new OreChunk(this, category, "IRON_ORE_CHUNK", "鐵石塊", 4, "44cc1ccc75d0f724af8a5fe273edaf4c6d5951f9e4d038f9f16e4f2673ce3833",
		SlimefunItems.IRON_DUST).register(this);
		
		new OreChunk(this, category, "GOLD_ORE_CHUNK", "金石塊", 2, "3184478b211439f3e2c509c3424ea5ff2fce73825c8bebf96cfccd103e4922eb",
		SlimefunItems.GOLD_DUST).register(this);
		
		new OreChunk(this, category, "COPPER_ORE_CHUNK", "銅石塊", 5, "60d748757d6efddde852e0a4a1a9b92f2e4c58b1ea9a1731a32f6cedf2c23b36",
		SlimefunItems.COPPER_DUST).register(this);
		
		new OreChunk(this, category, "TIN_ORE_CHUNK", "錫石塊", 3, "de2c955177ff65a2d55af17743755090a5a6b68b3586ccbc31a342dad9ef7799",
		SlimefunItems.TIN_DUST).register(this);
		
		new OreChunk(this, category, "SILVER_ORE_CHUNK", "銀石塊", 2, "dde8f949bbf3a42782c531fbf8de9dc2d8cd84dd7cb8f5d5328eeda83956aac8",
		SlimefunItems.SILVER_DUST).register(this);
		
		new OreChunk(this, category, "ALUMINUM_ORE_CHUNK", "鋁石塊", 4, "46732368c980b4c27495664bd50b5820cc37c573fb37a88f34c5d3a0dec66219",
		SlimefunItems.ALUMINUM_DUST).register(this);
		
		new OreChunk(this, category, "LEAD_ORE_CHUNK", "鉛石塊", 2, "2333fcec07c89c5fdb886caf5e3ebf8c6a536dd662b31f91c1a6dbd913bc3db0",
		SlimefunItems.LEAD_DUST).register(this);
		
		new OreChunk(this, category, "ZINC_ORE_CHUNK", "鋅石塊", 3, "63f82f20266b4b8e0456110379f941fca16413846e231e8ac202dc2caf7ffb41",
